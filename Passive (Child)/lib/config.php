...
//add_theme_support('bootstrap-responsive-max'); // On/Off Responsive Full-width mode
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      ...
      'page-fullwidth.php',
      'page-product.php',
      'page-portfolio-custom.php',
      'page-portfolio-custom2.php',
      'page-portfolio-custom3.php',
      'page-portfolio-custom4.php'
    )
  );
