...
<div id="master_wrap" class="portfolio-list">
...
<div id="myCarousel-auto" class="carousel slide carousel-fade page_banner_imgbox">
 ...
 <a class="right carousel-control" href="#myCarousel-auto" data-slide="next">›</a>
	...
	global $post;
	$args = array( 'numberposts' => 6, 'offset'=> 6, 'category' => 23 );  //Post Number, Offset (Exclude post), Category number 
   ...
   <!-- Page navigation -->
  	<div id="post-nav">
  	<a href="../category/portfolio-list/"> » View all news</a>
  	</div>
